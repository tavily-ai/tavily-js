...
// Step 4. Use exactMatch to only return results containing the exact phrase(s) inside quotes
const exactResponse = await tvly.search('"John Smith" CEO Acme Corp', { exactMatch: true });
console.log(exactResponse);
```
